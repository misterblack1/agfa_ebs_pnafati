...
**68K-MON** is a fully functional, UNIX-style ROM monitor built from scratch (based on the commands from SWTBUG) for a surplus Motorola 68000-based Agfa RIP/Printer controller I/O board. 
